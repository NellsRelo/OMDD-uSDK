...
class OMD4_API URSTSessionMissionSubsystem : public UGameInstanceSubsystem {
    GENERATED_BODY()
public:
    DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FRSTThreadChange, FUniqueNetIdRepl, PlayerId, const URSTMetaThreadDefinition*, Thread);
    DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FRSTTeamThreadChange, const URSTMetaTeamThreadDefinition*, Thread);
    DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FRSTPotionChangePlayer, FUniqueNetIdRepl, PlayerId);
    DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FRSTPotionChange, FUniqueNetIdRepl, PlayerId, const URSTPotionDefinition*, Potion);
    ...
    DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FRSTDistortionChange, const URSTMetaDistortionDefinition*, Distortion);
