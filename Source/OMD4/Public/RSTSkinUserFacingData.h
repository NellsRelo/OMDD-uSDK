...
public:
    ...
    static void SortSkinUserFacingArray(const TArray<URSTSkinUserFacingData*>& UserFacingArray, bool bAppendNullEntry, TArray<URSTSkinUserFacingData*>& OutUserFacingArray) const;
