...
public:
    ...
    static void SortUserFacingArray(const TArray<URSTPawnUserFacingData*>& UserFacingArray, TArray<URSTPawnUserFacingData*>& OutUserFacingArray) const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure=false)
    static void SortHeroTagArray(const TArray<FGameplayTag>& InTags, TArray<FGameplayTag>& OutTags) const;
