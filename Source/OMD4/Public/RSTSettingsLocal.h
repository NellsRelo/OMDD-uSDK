...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    void GetShadowsQualtiyOptions(TArray<FString>& OutOptions) const;
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    void GetGraphicsQualityOptions(TArray<FString>& OutOptions) const;
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    void GetFrameRateLimitOptions(TArray<FString>& OutOptions) const;
