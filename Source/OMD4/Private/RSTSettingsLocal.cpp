...
void URSTSettingsLocal::GetShadowsQualtiyOptions(TArray<FString>& OutOptions) const {
}
...
void URSTSettingsLocal::GetGraphicsQualityOptions(TArray<FString>& OutOptions) const {
}
...
void URSTSettingsLocal::GetFrameRateLimitOptions(TArray<FString>& OutOptions) const {
}
